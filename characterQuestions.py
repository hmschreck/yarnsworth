...
WEBHOOK = os.getenv("YARNSWORTH_TOKEN")
# Questions from http://dndspeak.com/2019/03/100-warm-up-roleplaying-questions-for-players/
QUESTIONS = [
...
requests.post(WEBHOOK, json_data, headers={"content-type":"application/json"})
